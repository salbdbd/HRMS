...
namespace HRMS.DbContext
{
    public static class Employee
    {
        ...
        public static EmpGenInfoModel GetEmpGenInfo(string empCode, int companyId)
        {
            using (var con = new SqlConnection(Connection.ConnectionString()))
            {
                string sql = "SELECT * FROM EmpGeneralInfo WHERE EmpCode='" + empCode + "' AND CompanyID=" + companyId;
